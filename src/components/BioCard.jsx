...
const BioCard = ({ aboutSection }) => (
  <div
    id="dashboard"
    className="max-md:min-h-88 md:min-h-80 md:flex-[3.6_1_0%] rounded-3xl p-8 md:p-9 relative flex flex-col justify-between bg-[#eef2f7] border border-white/85 shadow-[0_20px_60px_rgba(4,13,26,0.12)] scroll-mt-6"
  >
    ...
    <ul className="grid gap-3.5 text-[13px] list-none p-0 m-0">
      <li className="flex justify-between gap-4 border-b border-[rgba(99,123,155,0.22)] pb-2.5 text-[#26364a]">
        ...
        <span>{aboutSection?.cgpa}</span>
      </li>
      <li className="flex justify-between gap-4 border-b border-[rgba(99,123,155,0.22)] pb-2.5 text-[#26364a]">
        <span className="font-bold">Education</span>
        <span>{aboutSection?.education}</span>
      </li>
      <li className="flex justify-between gap-4 border-b border-[rgba(99,123,155,0.22)] pb-2.5 text-[#26364a]">
        <span className="font-bold">Sector Focus</span>
        <span>{aboutSection?.sectorFocus}</span>
      </li>
    </ul>
  </div>
);
