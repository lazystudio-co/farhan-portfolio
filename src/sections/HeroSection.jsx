...
const Skeleton = () => (
  <div className="portfolio-backdrop p-2 md:p-4 font-['Manrope'] text-[#1a1a1a] bg-[radial-gradient(circle_at_10%_0%,rgba(242,246,251,0.62),transparent_38%),radial-gradient(circle_at_86%_8%,rgba(223,229,236,0.58),transparent_34%)]">
    <div className="portfolio-shell w-full max-w-420 mx-auto flex flex-col p-3 md:p-5 rounded-2xl md:rounded-4xl bg-[#d5dbe3]/35 border border-white/35 shadow-[0_30px_60px_rgba(20,30,44,0.22)] backdrop-blur-[2px] animate-pulse">
